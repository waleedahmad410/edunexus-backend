...
export class Migration20260511090100Users extends Migration {
  override async up(): Promise<void> {
    this.addSql(`create table "users" ("id" uuid not null, "email" varchar(150) not null, "phone" varchar(20) null, "password_hash" varchar(255) not null, "status" varchar(30) not null, "last_login_at" timestamptz null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "users_pkey" primary key ("id"));`);
